...
class Part:
    def __init__(self, extent: BB, up: Coord = Coord(0, 0, 1), rotation: int = 0, translation: Coord = Coord(0, 0),
                 name="") -> None:
        self.extent = extent
        self.up = up
    ...
    def __repr__(self) -> str:
        return f"<Part {self.name}: {self.extent}, rot:{self.rotation}, tr:{self.translation}>"
